...
from ScenarioMP_Sensitivity_Analysis_v2 import simulate_encounter_1
...
Init_Param_Path = join_str(os.getcwd(), 'MonteCarlo', 'TwoAircraftEncounter', 'Init_Param_Sensitivity_Analysis_1.csv')
...
if __name__ == '__main__':
    ...
    results = executor.map(simulate_encounter_1, data)
    ...
    Results_Path = join_str(os.getcwd(), 'MonteCarlo', 'TwoAircraftEncounter',
                            'Results_Tracking_Sensitivity_Analysis_v2_s1.csv')
