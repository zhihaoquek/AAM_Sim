...
from ScenarioMP_Sensitivity_Analysis_v2 import simulate_encounter_2
...
Init_Param_Path = join_str(os.getcwd(), 'MonteCarlo', 'TwoAircraftEncounter', 'Init_Param_Sensitivity_Analysis_2.csv')
...
if __name__ == '__main__':
    ...
    results = executor.map(simulate_encounter_2, data)
    ...
    Results_Path = join_str(os.getcwd(), 'MonteCarlo', 'TwoAircraftEncounter',
                            'Results_Tracking_Sensitivity_Analysis_v2_s2.csv')
